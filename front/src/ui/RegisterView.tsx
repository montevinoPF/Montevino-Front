        ...
        {({ isSubmitting }) => (
          <Form className="flex flex-col items-center justify-center w-full max-w-sm gap-3 py-10 shadow-[0_0_15px_rgba(0,0,0,0.20)] px-7 rounded-2xl">
            ...
            <button
              ...
              className="py-2 mt-2 w-full bg-linear-to-r from-[#350A06] to-[#56070C] text-white font-semibold rounded-md shadow-md cursor-pointer hover:from-[#56070C] hover:to-[#350A06] transition-colors duration-300"
            >
              Registrarse
            </button>
            <span>o</span>
