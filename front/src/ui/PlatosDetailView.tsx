        ...
        <div className="grid gap-8 p-6 md:grid-cols-2 md:p-8">
          <div className="overflow-hidden h-260px md:h-420px rounded-2xl bg-white/60">
            <img
              src={plato.imageUrl}
              alt={plato.name}
              className="flex h-full overflow-hidden aspect-square rounded-2xl"
            />
          </div>

          <div className="flex flex-col justify-between">
            <div>
              <p className="font-serif text-red-800 text-2x1 md:text-4xl">
                {plato.name}
              </p>

              <p className="p-3 font-bold text-2x1 md:text-2xl text-slate-900">
                ${plato.price}
              </p>

              <div className="p-3 text-2x1 md:text-xl">
                <p className="font-semibold text-red-800 ">Ingredientes</p>
              ...
              <div className="p-3 text-2x1 md:text-xl">
                <p className="font-semibold text-red-800 ">Descripción</p>
