...
export default function CalendarCustom({ selectedDate, onSelect }: CalendarCustomProps) {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <button onClick={nextMonth} style={{
            ...
            color: "#2563eb", padding: 4, borderRadius: 6,
            display: "flex", alignItems: "center",
          }}>
              ...
              <div key={day} style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "3px 0" }}>
                <button
                  ...
                  style={{
                    ...
                    height: 38,
                    borderRadius: "50%",
                    border: isSelected ? "2.5px solid #1e3a8a" : "2px solid transparent",
                    background: isTod && !isSelected ? "#f1f5f9" : "transparent",
                  ...
                  onMouseLeave={e => {
                    if (!past && !isSelected)
                      (e.currentTarget as HTMLButtonElement).style.background = isTod ? "#f1f5f9" : "transparent";
                  }}
                >
                  {day}
                </button>
