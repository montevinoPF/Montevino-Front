...
const MapaFooter = dynamic(() => import("@/components/Mapa"), { ssr: false });
    ...
    <footer className="bg-linear-to-r from-[#350A06] to-[#56070C] text-[#FED0BB] py-2 px-2">
      <div className="w-[80%] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          />
          <p className="text-sm">
            Restaurante y bodega de excelencia. Experiencia gastronómica cálida
            y sofisticada.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link href="/" className="hover:text-[#FFD580] transition">
                Inicio
              </Link>
            </li>
            <li>
              <Link href="/menu" className="hover:text-[#FFD580] transition">
                Menú
              </Link>
            </li>
            {userData && (
            ...
            {!userData ? (
              <li>
                <Link href="/login" className="hover:text-[#FFD580] transition">
                  Iniciar sesión
                </Link>
              </li>
            ) : (
      ...
      <div className="mt-10 text-center text-xs text-[#FED0BB]/70">
        &copy; {new Date().getFullYear()} MONTEVINO. Todos los derechos
        reservados.
      </div>
    </footer>
  );
